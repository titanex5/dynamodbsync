...
```json
{
  ...
  "Statement": [{
    ...
    "Resource": "arn:aws:dynamodb:eu-central-1:TWOJE_ID_KONTA:table/player_data"
  }]
}
```
...
- **Komenda** `/playerdata get|set <gracz> <klucz> [wartość]` (uprawnienie
  `dynamosync.admin`, domyślnie tylko OP) — do ręcznego podglądu/edycji pól custom.
